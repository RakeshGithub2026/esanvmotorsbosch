      ...
      <div className="container-page grid gap-10 py-14 md:grid-cols-4">
        <div className="md:col-span-2">
          <div className="flex items-center gap-3">
            <img decoding="async" src={LOGOS.esanv} alt="ESANV MOTORS logo" width={96} height={96}
            ...
            <img decoding="async" src={LOGOS.bosch} alt="Bosch Car Service logo" width={88} height={88}
